...
def set_config(app):
	...
	app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://avnadmin:AVNS_hJ17HcmZcO2Vc_wPKaF@mysql-24a408de-malali3b-c223.c.aivencloud.com:11284/defaultdb?sql-mode=REQUIRED"
